...
function Diagram () {
  return (
    ...
    <Image src='https://success.outsystems.com/TK_Resource/b449fa16-f1aa-451b-bbc4-4bb6aa05a945' alt='auth' isZoomed className='size-5/6 mx-auto'/>
    <Link href="https://success.outsystems.com/documentation/outsystems_developer_cloud/managing_outsystems_platform_and_apps/cloud_native_architecture_of_outsystems_developer_cloud/architecture_of_authentication_and_authorization_mechanism/"
    isExternal
    showAnchorIcon
    className="text-xs"
    >

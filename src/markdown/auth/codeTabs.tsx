...
export function CodeTabs() {
  return (
    <div className="flex w-full flex-col ">
      <Tabs aria-label="CodeTabs" variant="bordered" size="sm" color="primary" radius="sm">
        <Tab key="dependency" title={
          ...
          <Card className="shadow-none bg-transparent">
            <CardBody className="py-[1px] px-0">
              <CodeComparison
                code={dependency}
                language="bash"
                filename="Bash"

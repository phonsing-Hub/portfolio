...
### การทำงานโดยรวม
1. **Login Route (/api/v1/login)** รับ Username และ Password จาก Body และตรวจสอบความถูกต้องของข้อมูล ถ้าข้อมูลถูกต้อง จะสร้าง JWT Token พร้อมข้อมูลผู้ใช้ (sub) เวลาหมดอายุ (exp) และแนบกลับไป ผ่าน Cookie ที่ชื่อว่า auth
2. **Protected Routes (/api/home)** การเข้าถึงข้อมูลที่ได้รับการป้องกัน โดยจะมี middleware (Decode) จะทำการตรวจสอบ Token ที่แนบมาพร้อมกับ cookie หาก token ถูกต้อง จะส่งข้อความกลับไป “Welcome to the home route” พร้อม userID
<div className="border-b"/>
